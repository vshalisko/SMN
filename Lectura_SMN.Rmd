...
```{r}
files <- list.files(path = "./Base", pattern = "^dia.*\\.txt$")
files
```
...
```{r}
datos_1001_corto <- smn_data_df[smn_data_df$ESTACION == 1001
                          & smn_data_df$FECHA >= as.Date("1980-01-01")
                          & smn_data_df$FECHA < as.Date("2011-01-01"), ]

t_mens_locales_1001_corto <- promedios_locales_t(datos_1001_corto)
head(t_mens_locales_1001_corto)
p_mens_locales_1001_corto <- sumas_locales_p(datos_1001_corto)
head(p_mens_locales_1001_corto)

draw_plot_t <- function(x, y, ysd, yn, color) {
  plot(x = x, y = y, 
     col=color, type="l", cex=0.5,
     ylim=c(min(y, na.rm = TRUE)-mean(ysd, na.rm = TRUE),
            max(y, na.rm = TRUE)+mean(ysd, na.rm = TRUE)))
...
draw_plot_t(x=t_mens_locales_1001_corto$FECHA,
            y=t_mens_locales_1001_corto$TMIN,
            ysd=t_mens_locales_1001_corto$TMIN_SD,
            yn=t_mens_locales_1001_corto$TMIN_N,
            color="blue")

draw_plot_t(x=t_mens_locales_1001_corto$FECHA,
            y=t_mens_locales_1001_corto$TMAX,
            ysd=t_mens_locales_1001_corto$TMAX_SD,
            yn=t_mens_locales_1001_corto$TMAX_N,
            color="red")

draw_plot_t(x=p_mens_locales_1001_corto$FECHA,
            y=p_mens_locales_1001_corto$PREC,
            ysd=p_mens_locales_1001_corto$PREC_SD,
            yn=p_mens_locales_1001_corto$PREC_N,
            color="black")

draw_plot_t(x=p_mens_locales_1001_corto$FECHA,
            y=p_mens_locales_1001_corto$EVAP,
            ysd=p_mens_locales_1001_corto$EVAP_SD,
            yn=p_mens_locales_1001_corto$EVAP_N,
            color="darkgreen")
```
...
```{r}
t_mens_locales_1001_periodo_corto <- promedios_locales_periodo(datos_1001_corto)
head(t_mens_locales_1001_periodo_corto)
draw_plot_t(x=t_mens_locales_1001_periodo_corto$D,
            y=t_mens_locales_1001_periodo_corto$TMIN,
            ysd=t_mens_locales_1001_periodo_corto$TMIN_SD,
            yn=t_mens_locales_1001_periodo_corto$TMIN_N,
            color="blue")
draw_plot_t(x=t_mens_locales_1001_periodo_corto$D,
            y=t_mens_locales_1001_periodo_corto$TMAX,
            ysd=t_mens_locales_1001_periodo_corto$TMAX_SD,
            yn=t_mens_locales_1001_periodo_corto$TMAX_N,
            color="red")
draw_plot_t(x=t_mens_locales_1001_periodo_corto$D,
            y=t_mens_locales_1001_periodo_corto$PREC,
            ysd=t_mens_locales_1001_periodo_corto$PREC_SD,
            yn=t_mens_locales_1001_periodo_corto$PREC_N,
            color="black")
draw_plot_t(x=t_mens_locales_1001_periodo_corto$D,
            y=t_mens_locales_1001_periodo_corto$EVAP,
            ysd=t_mens_locales_1001_periodo_corto$EVAP_SD,
            yn=t_mens_locales_1001_periodo_corto$EVAP_N,
            color="darkgreen")
```


```{r}
datos_1001 <- smn_data_df[smn_data_df$ESTACION == 1001
                          & smn_data_df$FECHA >= as.Date("1970-01-01"), ]
dim(datos_1001)

t_mens_1001 <- promedios_mensuales_t(datos_1001)

head(t_mens_1001)
plot(x=as.numeric(t_mens_1001$M),y=t_mens_1001$TMIN, col="blue")
plot(x=as.numeric(t_mens_1001$M),y=t_mens_1001$TMAX, col="red")

p_mens_1001 <- sumas_mensuales_p(datos_1001)

head(p_mens_1001)
plot(x=as.numeric(p_mens_1001$M),y=p_mens_1001$PREC, col="black")
plot(x=as.numeric(p_mens_1001$M),y=p_mens_1001$EVAP, col="darkgreen")

t_mens_locales_1001 <- promedios_locales_t(datos_1001)
head(t_mens_locales_1001)

plot(x=t_mens_locales_1001$FECHA,y=t_mens_locales_1001$TMIN, col="blue", type="l")
plot(x=t_mens_locales_1001$FECHA,y=t_mens_locales_1001$TMAX, col="red", type="l")

plot(x=as.numeric(t_mens_locales_1001$D),y=t_mens_locales_1001$TMIN, col="blue", type="p", cex=0.5)
plot(x=as.numeric(t_mens_locales_1001$D),y=t_mens_locales_1001$TMAX, col="red", type="p", cex=0.5)
```
